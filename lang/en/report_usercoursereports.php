...
$string['invalidtypeparam'] = 'Invalid report type param.';
$string['invalidcreatedfromdate'] = 'Invalid created from date, it must be smaller than created to date.';
$string['invalidcreatedtodate'] = 'Invalid created to date, it must be bigger than created from date.';
$string['invalidstartdatefrom'] = 'Invalid start from date, it must be smaller than start to date.';
$string['invalidstartdateto'] = 'Invalid start to date, it must be bigger than start from date.';
$string['invalidperpage'] = 'Invalid per page, it must be between 1 to 1000.';
